...
router.get('/:id',validation(validators.getSpecificCategory),auth(endPoint.specific),asyncHandler(categoriesController.SpecificCategory));
router.post('/',validation(validators.createCategory),auth(endPoint.create),fileUpload(fileValidation.image).single('image'),categoriesController.createCategory)
